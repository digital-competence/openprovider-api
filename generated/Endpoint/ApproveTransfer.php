...
class ApproveTransfer extends \DigiComp\OpenproviderApi\Runtime\Client\BaseEndpoint implements \DigiComp\OpenproviderApi\Runtime\Client\Endpoint
{
    protected $id;
    /**
     *
     ...
     */
    public function __construct(int $id, \DigiComp\OpenproviderApi\Model\DomainApproveTransferRequest $body)
    {
        $this->id = $id;
        $this->body = $body;
    }
    ...
    {
        return str_replace(array('{id}'), array($this->id), '/v1beta/domains/{id}/transfer/approve');
    }
