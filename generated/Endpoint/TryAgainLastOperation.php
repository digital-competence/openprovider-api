...
class TryAgainLastOperation extends \DigiComp\OpenproviderApi\Runtime\Client\BaseEndpoint implements \DigiComp\OpenproviderApi\Runtime\Client\Endpoint
{
    protected $id;
    /**
     *
     ...
     */
    public function __construct(int $id, \DigiComp\OpenproviderApi\Model\DomainTryAgainLastOperationRequest $body)
    {
        $this->id = $id;
        $this->body = $body;
    }
    ...
    {
        return str_replace(array('{id}'), array($this->id), '/v1beta/domains/{id}/last-operation/restart');
    }
