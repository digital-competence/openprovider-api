...
class UpdateVirtuozzoLicense extends \DigiComp\OpenproviderApi\Runtime\Client\BaseEndpoint implements \DigiComp\OpenproviderApi\Runtime\Client\Endpoint
{
    protected $key_id;
    /**
     *
     ...
     */
    public function __construct(int $keyId, \DigiComp\OpenproviderApi\Model\LicenseUpdateVirtuozzoLicenseRequest $body)
    {
        $this->key_id = $keyId;
        $this->body = $body;
    }
