...
class ProductSslProductLevelPricesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'DigiComp\\OpenproviderApi\\Model\\ProductSslProductLevelPrices';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'DigiComp\\OpenproviderApi\\Model\\ProductSslProductLevelPrices';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \DigiComp\OpenproviderApi\Model\ProductSslProductLevelPrices();
        ...
        if (\array_key_exists('prices', $data) && $data['prices'] !== null) {
            ...
            foreach ($data['prices'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'DigiComp\\OpenproviderApi\\Model\\ProductSslProductPrices', 'json', $context);
            }
