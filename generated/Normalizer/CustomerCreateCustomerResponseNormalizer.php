...
class CustomerCreateCustomerResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'DigiComp\\OpenproviderApi\\Model\\CustomerCreateCustomerResponse';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'DigiComp\\OpenproviderApi\\Model\\CustomerCreateCustomerResponse';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \DigiComp\OpenproviderApi\Model\CustomerCreateCustomerResponse();
        ...
        if (\array_key_exists('data', $data) && $data['data'] !== null) {
            $object->setData($this->denormalizer->denormalize($data['data'], 'DigiComp\\OpenproviderApi\\Model\\CustomerCreateCustomerResponseData', 'json', $context));
