...
class SettingsGetSettingsResponseDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'DigiComp\\OpenproviderApi\\Model\\SettingsGetSettingsResponseData';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'DigiComp\\OpenproviderApi\\Model\\SettingsGetSettingsResponseData';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \DigiComp\OpenproviderApi\Model\SettingsGetSettingsResponseData();
        ...
        if (\array_key_exists('signed_contracts', $data) && $data['signed_contracts'] !== null) {
            $values_4 = array();
            foreach ($data['signed_contracts'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'DigiComp\\OpenproviderApi\\Model\\SettingsSignedContracts', 'json', $context);
            }
            $object->setSignedContracts($values_4);
        } elseif (\array_key_exists('signed_contracts', $data) && $data['signed_contracts'] === null) {
            $object->setSignedContracts(null);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getSignedContracts()) {
            $values_4 = array();
