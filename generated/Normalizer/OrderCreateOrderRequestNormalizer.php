...
class OrderCreateOrderRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'DigiComp\\OpenproviderApi\\Model\\OrderCreateOrderRequest';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'DigiComp\\OpenproviderApi\\Model\\OrderCreateOrderRequest';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \DigiComp\OpenproviderApi\Model\OrderCreateOrderRequest();
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getDomainAmount()) {
        ...
        if (null !== $object->getWildcardDomainAmount()) {
