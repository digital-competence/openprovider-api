...
class ContactListContactsResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'DigiComp\\OpenproviderApi\\Model\\ContactListContactsResponse';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'DigiComp\\OpenproviderApi\\Model\\ContactListContactsResponse';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \DigiComp\OpenproviderApi\Model\ContactListContactsResponse();
        ...
        if (\array_key_exists('data', $data) && $data['data'] !== null) {
            $object->setData($this->denormalizer->denormalize($data['data'], 'DigiComp\\OpenproviderApi\\Model\\ContactListContactsResponseData', 'json', $context));
