...
class InvoicePricesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'DigiComp\\OpenproviderApi\\Model\\InvoicePrices';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'DigiComp\\OpenproviderApi\\Model\\InvoicePrices';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \DigiComp\OpenproviderApi\Model\InvoicePrices();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('product', $data) && $data['product'] !== null) {
            $object->setProduct($this->denormalizer->denormalize($data['product'], 'DigiComp\\OpenproviderApi\\Model\\InvoicePrice', 'json', $context));
        ...
        if (\array_key_exists('reseller', $data) && $data['reseller'] !== null) {
            $object->setReseller($this->denormalizer->denormalize($data['reseller'], 'DigiComp\\OpenproviderApi\\Model\\InvoicePrice', 'json', $context));
